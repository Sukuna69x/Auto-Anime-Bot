...
class Var:
    ...
    FFCODE_2160 = getenv("FFCODE_2160") or """ffmpeg -i '{}' -progress '{}' -preset fast -c:v libx264 -s 3840x2160 -pix_fmt yuv420p -crf 30 -c:a libopus -b:a 32k -c:s copy -map 0 -ac 2 -ab 32k -vbr 2 -level 3.1 '{}' -y"""
    QUALS = getenv("QUALS", "480 720 1080 2160").split()
